...
namespace Entidades
{
    public class ClienteCtaCte : AsientoContable
    {
        ...
        public ClienteCtaCte() { }
        public ClienteCtaCte(long id, long asientoNro, DateTime asientoFecha, CuentaContable cuentaContable, string descripcion, double debe, double haber, double saldo, string origenTipo, long origenId, string denominacion, string cuit)

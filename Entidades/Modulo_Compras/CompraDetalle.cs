namespace Entidades
{
    public class CompraDetalle
    {
        ...
        public CompraDetalle(long id, Compra compra, long idArticulo, string denominacion, int cantidad, string unidad, string deposito, double costoUnitario, string alicuotaIVA, double BaseIVA, double costoNeto, CentroCosto centroCosto)
        {
            _id = id;
            _compra = compra;

...
{
    public partial class FormBaseCatalogo_EditableC3 : Biblioteca.Formularios.FormBaseModal
    {
        #region Atributos
        private int _indicePaginaActual = 0;
        #endregion

        public FormBaseCatalogo_EditableC3()
        {
            InitializeComponent();
        }

        #region Eventos
        private void FormBaseModal_CatalogoC3_Load(object sender, EventArgs e)
        {
            #region ToolTips
        ...
        private void FormBaseModal_CatalogoC3_Shown(object sender, EventArgs e)
        {
        ...
        private void btnEditarCatalogo_Click(object sender, EventArgs e)
        {
            Formulario.Visibilidad(new Control[] { btnEditarCatalogo, txtElementoDenominacion,
                txtElementoCodigo, btnNuevo, btnCancelar, btnGuardar, btnEliminar });
        }
        #endregion
